...
{
    let result = await articleDeleteService(row);
    ElMessage.success(result.message ? result.message : '操作成功')
    //再次调用getArticles,获取文章
    getArticleList()
    ...
    <el-drawer v-model="visibleDrawer" title="添加文章" direction="rtl" size="50%">
        ...
        <el-form :model="articleModel" label-width="100px">
            ...
            <el-form-item>
                ...
                <el-button v-if="articleModel.state==''" type="primary" @click="addArticle('已发布')">发布文章</el-button>
                <el-button v-if="articleModel.state==''" type="info" @click="addArticle('草稿')">存草稿</el-button>

                <el-button v-if="articleModel.state=='已发布'||articleModel.state=='草稿'" type="info" @click="updateArticle()">修改文章</el-button>
                <el-button v-if="articleModel.state=='草稿'" type="primary" @click="articleModel.state='已发布',updateArticle()">发布文章</el-button>
            </el-form-item>
        </el-form>
    </el-drawer>
</template>
